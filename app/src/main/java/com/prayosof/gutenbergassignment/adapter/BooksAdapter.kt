package com.prayosof.gutenbergassignment.adapter
...
import com.prayosof.gutenbergassignment.R
import com.prayosof.gutenbergassignment.interfaces.OnBooksItemClick
import com.prayosof.gutenbergassignment.model.Results
 ...
 */
class BooksAdapter(booksList: ArrayList<Results>, context: Context, listner : OnBooksItemClick) : RecyclerView.Adapter<BooksAdapter.BooksViewHolder>(),Filterable {
